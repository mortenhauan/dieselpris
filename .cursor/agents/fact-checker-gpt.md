...
description: >
  ...
  the end of the journalist step — run in parallel with fact-checker-claude,
  fact-checker-grok, and fact-checker-gemini.
---
...
## Faktasjekk — `{slug}` — gpt-5.4-medium
