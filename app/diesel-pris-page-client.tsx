...
export function DieselPrisPageClient({
  data,
          ...
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-12">
              ...
              <p className="text-muted-foreground max-w-xl">
                Se hvordan råvarepris, avgifter og modellert regional
                distribusjon bygger opp prisestimatet.
              </p>
                ...
                <div className="bg-card rounded-2xl border border-border p-6 md:p-8 h-full flex flex-col">
                  <div className="mb-6">
                    ...
                    <p className="text-sm text-muted-foreground">
                      Estimert pumpepris for{" "}
                      {selectedRegion.label.toLowerCase()}. Historiske punkter
                      bruker avgiftssatsene som gjaldt på datoen.
                    </p>
                  </div>
                  {historical.length > 0 ? (
        ...
        <section className="py-16 md:py-24 bg-secondary/50">
          <div className="max-w-6xl mx-auto px-6">
            <div className="mb-12">
              ...
              <p className="text-muted-foreground max-w-xl">
                Estimert pumpepris for {selectedRegion.label.toLowerCase()},
                basert på terminkontrakter fra ICE-børsen og dagens avgifter.
              </p>
            </div>
            {contracts.length > 0 ? (
              <FuturesForecast
              ...
              <p className="text-sm text-muted-foreground max-w-2xl">
                Terminkurve med flere måneder vises når vi har kontraktsrekke
                fra børsen. Akkurat nå viser vi én sammenhengende gasoil-serie
                for dagspris og historikk.
              </p>
            )}
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-secondary/50">
          <div className="max-w-3xl mx-auto px-6">
            ...
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>
                Dieselprisen i Norge bestemmes av flere faktorer. Den viktigste
                er råvarepris på diesel, som handles på internasjonale børser
                som{" "}
              ...
              <p>
                ...
                . For å beregne prisen per liter i Norge, må vi regne om fra
                tonn til liter (1 MT = ca. 1176 liter diesel) og fra USD til NOK
                basert på dagens valutakurs.
              </p>
              <p>
                ...
                i ren råvarepris (avhengig av valutakurs). Når vi legger til
                distribusjon, margin og avgifter, får du et prisestimat som kan
                justeres etter region lenger opp på siden.
              </p>
            </div>
          </div>
        </section>
